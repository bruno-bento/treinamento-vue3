  ...
  <div class="flex justify-center w-full h-full">
    <div class="flex flex-col w-4/5 max-w-6xl py-10">
      ...
      <content-loader
        ...
        height="50px"
      />
      <div v-else class="py-3 pl-5 pr-20 mt-2 rounded bg-brand-gray w-full lg:w-2/3 overflow-y-scroll">
        <span v-if="state.hasError"> Erro ao carregar o script</span>
        <pre v-else>
&lt;script defer async onload="init('{{ store.User.currentUser.apiKey }}')" src="https://bruno-bento-feedbacker-dashboard.netlify.app/init.js"&gt;&lt;/script&gt;
        </pre>
      </div>
    </div>
  </div>
